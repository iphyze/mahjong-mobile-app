    ...
    try {
      ...
      const flutterwaveConfig = {
        ...
        customizations: {
          ...
          description: 'Tutorship Subscription',
        },
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.navBar}>
            ...
            <Text style={styles.title}>Tutorship Payment</Text>
        </View>
        ...
        {!paymentUrl ? (
          ...
          <Animatable.View animation={'fadeInUp'} delay={500} style={styles.orderContainer}>
              ...
              <Text style={styles.amountHeading}>Tutorship Amount</Text>
            ...
            <View style={styles.contextFlex}>
              ...
              <View style={styles.contextwrapper}>
                ...
                <Text style={styles.contextTextMain}>Tutorship Payment</Text>
              </View>
            </View>
...
export default TutorshipPaymentScreen;